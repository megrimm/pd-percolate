...
static void bowedbar_float(t_bowedbar *x, t_floatarg f)
{
		x->x_bp = f;
}

static void bowedbar_bpos(t_bowedbar *x, t_floatarg f)
{
	x->x_bpos = f;
}

		
static void bowedbar_bv(t_bowedbar *x, t_floatarg f)
{
	x->x_bv = f;
}

		
static void bowedbar_GAIN(t_bowedbar *x, t_floatarg f)
{
	x->x_GAIN = f;
}
...
static void bowedbar_freq(t_bowedbar *x, t_floatarg f)
{
	x->x_freq = f;
}
...
{
	bowedbar_class = class_new(gensym("bowedbar~"), (t_newmethod)bowedbar_new, (t_method)bowedbar_free,
        sizeof(t_bowedbar), 0, 0);
    class_addmethod(bowedbar_class, nullfn, gensym("signal"), A_NULL);
    class_addmethod(bowedbar_class, (t_method)bowedbar_dsp, gensym("dsp"), A_NULL);
	class_addfloat(bowedbar_class, (t_method)bowedbar_float);
// 	class_addbang(bowedbar_class, (t_method)bowedbar_bang);
    class_addmethod(bowedbar_class, (t_method)bowedbar_bpos, gensym("bpos"), A_FLOAT, A_NULL);
    class_addmethod(bowedbar_class, (t_method)bowedbar_bv, gensym("bv"), A_FLOAT, A_NULL);
    class_addmethod(bowedbar_class, (t_method)bowedbar_GAIN, gensym("GAIN"), A_FLOAT, A_NULL);
    class_addmethod(bowedbar_class, (t_method)bowedbar_integration_const_, gensym("integration_const_"), A_FLOAT, A_NULL);
    class_addmethod(bowedbar_class, (t_method)bowedbar_freq, gensym("freq"), A_FLOAT, A_NULL);
