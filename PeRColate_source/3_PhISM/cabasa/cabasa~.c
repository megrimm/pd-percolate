...
static void cabasa_float(t_cabasa *x, t_floatarg f)
{
	x->num_objects = f;

}

static void cabasa_res_freq(t_cabasa *x, t_floatarg f)
{
	x->res_freq = f;
}

static void cabasa_shake_damp(t_cabasa *x, t_floatarg f)
{
	x->shake_damp = f;
}

static void cabasa_shake_max(t_cabasa *x, t_floatarg f)
{
	x->shake_max = f;
}
...
void cabasa_tilde_setup(void)
{
    ...
    class_addmethod(cabasa_class, (t_method)cabasa_res_freq, gensym("res_freq"), A_FLOAT, A_NULL);
    class_addmethod(cabasa_class, (t_method)cabasa_shake_damp, gensym("shake_damp"), A_FLOAT, A_NULL);
    class_addmethod(cabasa_class, (t_method)cabasa_shake_max, gensym("shake_max"), A_FLOAT, A_NULL);
}
#endif /* PD */
