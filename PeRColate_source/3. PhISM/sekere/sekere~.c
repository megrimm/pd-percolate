...
sekere_tilde_setup(void)
{
  ...
  class_addmethod(sekere_class, (t_method)sekere_res_coeff, gensym("res_coeff"), A_FLOAT, 0);
  class_addmethod(sekere_class, (t_method)sekere_shake_dump, gensym("shake_dump"), A_FLOAT, 0);
  class_addmethod(sekere_class, (t_method)sekere_shake_max, gensym("shake_max"), A_FLOAT, 0);
