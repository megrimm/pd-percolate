...
static void agogo_float(t_agogo *x, t_floatarg f)
{
		x->x_sh = f;
}

static void agogo_spos(t_agogo *x, t_floatarg f)
{
	x->x_spos = f;
}

		
static void agogo_sa(t_agogo *x, t_floatarg f)
{
	x->x_sa = f;
}

		
static void agogo_vf(t_agogo *x, t_floatarg f)
{
	x->x_vf = f;
}

		
static void agogo_va(t_agogo *x, t_floatarg f)
{
	x->x_va = f;
}

		
static void agogo_freq(t_agogo *x, t_floatarg f)
{
	x->x_fr = f;
}
...
{
    agogo_class = class_new(gensym("agogo~"), (t_newmethod)agogo_new, (t_method)agogo_free,
        sizeof(t_agogo), 0, 0);
    ...
    class_addmethod(agogo_class, (t_method)agogo_spos, gensym("spos"), A_FLOAT, A_NULL);
    class_addmethod(agogo_class, (t_method)agogo_sa, gensym("sa"), A_FLOAT, A_NULL);
    class_addmethod(agogo_class, (t_method)agogo_vf, gensym("vf"), A_FLOAT, A_NULL);
    class_addmethod(agogo_class, (t_method)agogo_va, gensym("va"), A_FLOAT, A_NULL);
    class_addmethod(agogo_class, (t_method)agogo_freq, gensym("freq"), A_FLOAT, A_NULL);
    class_addmethod(agogo_class, (t_method)agogo_noteon, gensym("noteon"), A_NULL);
    class_addmethod(agogo_class, (t_method)agogo_noteoff, gensym("noteoff"), A_NULL);
}
#endif /* PD */
