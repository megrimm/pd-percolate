...
static t_int *metashake_perform(t_int *w)
{
	...
	if(!x->power)  {
		...
		if(num_objects != x->num_objectsSave) {
			...
			x->num_objects = num_objects;
			x->num_objectsSave = num_objects;
			x->gain = log(num_objects) / log(4.0) * 120.0 / (t_float) num_objects;
		}
...
static void metashake_float2(t_metashake *x, t_floatarg f)
{
		x->shake_max = f;
}
static void metashake_float3(t_metashake *x, t_floatarg f)
{
		x->res_freq = f;
}
static void metashake_float4(t_metashake *x, t_floatarg f)
{
		x->res_freq1 = f;
}
static void metashake_float5(t_metashake *x, t_floatarg f)
{
		x->res_freq2 = f;
}
void metashake_float6(t_metashake *x, t_floatarg f)
{
		x->res_freq3 = f;
}
static void metashake_float7(t_metashake *x, t_floatarg f)
{
		x->res_freq4 = f;
}
static void metashake_float8(t_metashake *x, t_floatarg f)
{
		x->scrapeVel = f;
}
...
{
    metashake_class = class_new(gensym("metashake~"), (t_newmethod)metashake_new, 0,
        sizeof(t_metashake), 0, 0);
    class_addmethod(metashake_class, nullfn, gensym("signal"), A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_dsp, gensym("dsp"), A_NULL);
	...
	class_addmethod(metashake_class, (t_method)metashake_setsleigh, gensym("sleigh"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_setbamboo, gensym("bamboo"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_setguiro, gensym("guiro"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_settamb, gensym("tambourine"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_setseke, gensym("sekere"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_setcabasa, gensym("cabasa"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_setmaraca, gensym("maraca"), A_NULL);
	class_addmethod(metashake_class, (t_method)metashake_setoff, gensym("off"), A_NULL);
	class_addmethod(metashake_class, (t_method)setpower, gensym("power"), A_GIMME, A_NULL);
		/* float inlets */
    class_addmethod(metashake_class, (t_method)metashake_float1, gensym("shake_damp"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float2, gensym("shake_max"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float3, gensym("res_freq"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float4, gensym("res_freq1"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float5, gensym("res_freq2"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float6, gensym("res_freq3"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float7, gensym("res_freq4"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float8, gensym("scrapeVel"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float9, gensym("res_spread"), A_FLOAT, A_NULL);
    class_addmethod(metashake_class, (t_method)metashake_float10, gensym("res_random"), A_FLOAT, A_NULL);
