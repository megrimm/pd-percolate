...
static void marimba_float(t_marimba *x, t_floatarg f)
{
		x->x_sh = f;
}

static void marimba_spos(t_marimba *x, t_floatarg f)
{
	x->x_spos = f;
}

		
static void marimba_sa(t_marimba *x, t_floatarg f)
{
	x->x_sa = f;
}

		
static void marimba_vf(t_marimba *x, t_floatarg f)
{
	x->x_vf = f;
}

		
static void marimba_va(t_marimba *x, t_floatarg f)
{
	x->x_va = f;
}

		
static void marimba_freq(t_marimba *x, t_floatarg f)
{
	x->x_fr = f;
}
...
{
	marimba_class = class_new(gensym("marimba~"), (t_newmethod)marimba_new, (t_method)marimba_free,
        sizeof(t_marimba), 0, 0);
    class_addmethod(marimba_class, nullfn, gensym("signal"), A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_dsp, gensym("dsp"), A_NULL);
	class_addfloat(marimba_class, (t_method)marimba_float);
    class_addmethod(marimba_class, (t_method)marimba_spos, gensym("spos"), A_FLOAT, A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_sa, gensym("sa"), A_FLOAT, A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_vf, gensym("vf"), A_FLOAT, A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_va, gensym("va"), A_FLOAT, A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_freq, gensym("freq"), A_FLOAT, A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_noteon, gensym("noteon"), A_NULL);
    class_addmethod(marimba_class, (t_method)marimba_noteoff, gensym("noteoff"), A_NULL);
}
