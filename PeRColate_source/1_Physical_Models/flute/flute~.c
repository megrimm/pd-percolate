...
static void flute_float(t_flute *x, t_floatarg f)
{
		x->x_bp = f;
}

static void flute_jd(t_flute *x, t_floatarg f)
{
	x->x_jd = f;
}

		
static void flute_ng(t_flute *x, t_floatarg f)
{
	x->x_ng = f;
}

		
static void flute_vf(t_flute *x, t_floatarg f)
{
	x->x_vf = f;
}

		
static void flute_va(t_flute *x, t_floatarg f)
{
	x->x_va = f;
}

		
static void flute_freq(t_flute *x, t_floatarg f)
{
	x->x_fr = f;
}
...
{
    flute_class = class_new(gensym("flute~"), (t_newmethod)flute_new, (t_method)flute_free,
        sizeof(t_flute), 0, 0);
...
// 	class_addbang(flute_class, (t_method)flute_bang);
    class_addmethod(flute_class, (t_method)flute_jd, gensym("jd"), A_FLOAT, A_NULL);
    class_addmethod(flute_class, (t_method)flute_ng, gensym("ng"), A_FLOAT, A_NULL);
    class_addmethod(flute_class, (t_method)flute_vf, gensym("vf"), A_FLOAT, A_NULL);
    class_addmethod(flute_class, (t_method)flute_va, gensym("va"), A_FLOAT, A_NULL);
    class_addmethod(flute_class, (t_method)flute_freq, gensym("freq"), A_FLOAT, A_NULL);
}
#endif /* PD */
